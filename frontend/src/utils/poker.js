...
const setCardIdsToUint8 = (positions) => {
  let binaryNumber = 0;
...
function getCardIdsFromUint8(num) {
...
export { mapPokerIdToCardId, sortPokersById, sortPokersByRule, getCardIdsFromUint8, setCardIdsToUint8 };
